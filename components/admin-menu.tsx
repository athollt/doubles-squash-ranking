...
import { adminLinksFor, slugFromPathname, type Role } from "@/lib/nav";
...
// Users page for an admin. Off a league route only the admin-global links apply,
// so a non-admin sees nothing and the menu is hidden.
export function AdminMenu({ role }: { role: Role }) {
  ...
  // global Users link; a scorer has nothing to show.
  const links = slug
