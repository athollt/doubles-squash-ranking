...
## Context
- Runs after 16.1–16.5 and after any `/review-changes` pass.
...
3. **`docs/plans/RESEARCH-whatsapp-notifications.md`** — the WhatsApp share
   direction was chosen and built in step 16.4 (Web Share API tap-to-share);
   confirm the research doc and `DECISIONS.md` reflect that, and that no stale
   "open follow-up" wording remains.
...
3. Commit `step-16.6: update documentation`.
4. Push `at-wip`.
